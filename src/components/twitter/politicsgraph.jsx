		...
		<Flex align="center" justify="center">
			...
			<VStack mx={10}>
				<Heading fontSize={30}>
					...
					total of 1,310,828 times and like a total of 4,488,173
					times"
				</Heading>
				<Text fontSize={17}>
					Online as well, Social Media proved to be a platform for
					hate to proliferate. In the first eight months of the
					COVID-19 pandemic, researchers examined the tweets issued by
					both Republican and Democrat general election candidates for
					the offices of President, Vice President, and U.S. Senator.
					Researchers searched for tweets that contained any terms
					relating to AAPI from their accounts, and analyzed their
					rhetoric and intent.
				</Text>
			</VStack>
		</Flex>
